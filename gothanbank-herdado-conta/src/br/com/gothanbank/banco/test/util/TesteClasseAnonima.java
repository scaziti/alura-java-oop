...
public class TesteClasseAnonima {
	...
	public static void main(String[] args) {
		...
		// Function Object
		// Aqui crio duas classes anonimas
		// Passando a interface Comparator, ao invés de criar uma classe apenas pra isso!
		// Preciso do parenteses, para chamar o construtor 
